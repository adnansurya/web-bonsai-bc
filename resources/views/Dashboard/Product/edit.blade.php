    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <form action="/dashboard/product/{{ $product->id }}" method="POST" class="needs-validation" novalidate
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input name="price" value="{{ old('price',$product->price) }}" class="form-control"
                                type="text" placeholder="Masukan Harga Produk" id="price" required>
                            <div class="invalid-feedback">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input name="stock" value="{{ old('stock',$product->stock) }}" class="form-control"
                                type="text" placeholder="Masukan Stok Produk" id="stock" required>
                            <div class="invalid-feedback">
                                *Harga Tidak Boleh Kosong!
                            </div>
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="hidden" value="{{ $product->image }}"  name="oldImage" id="">
