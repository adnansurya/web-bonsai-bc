        ...
        <div class="wrap-footer flex-w p-t-60 p-b-62">
            <div class="footer-col1">
                <div class="footer-col-title">
                    <a href="#">
                        <img src="/LP/assets/images/icons/logo-02.png" alt="LOGO">
                    </a>
                </div>
            ...
            <div class="footer-col4">
                ...
                <form class="flex-w">
                    ...
                    <button class="flex-c-m size-a-10 bg10 hov-btn2 trans-04">
                        <img src="/LP/assets/images/icons/icon-send.png" alt="SENT">
                    </button>
                </form>
            </div>
        </div>
        ...
        <div class="flex-w flex-sb-m bo-t-1 bocl16 p-tb-14">
            ...
            <div class="flex-w flex-m">
                <a href="#" class="m-r-29 m-tb-10">
                    <img src="/LP/assets/images/icons/icon-pay-01.png" alt="ICON-PAY">
                </a>

                <a href="#" class="m-r-29 m-tb-10">
                    <img src="/LP/assets/images/icons/icon-pay-02.png" alt="ICON-PAY">
                </a>

                <a href="#" class="m-r-29 m-tb-10">
                    <img src="/LP/assets/images/icons/icon-pay-03.png" alt="ICON-PAY">
                </a>

                <a href="#" class="m-r-29 m-tb-10">
                    <img src="/LP/assets/images/icons/icon-pay-04.png" alt="ICON-PAY">
                </a>

                <a href="#">
                    <img src="/LP/assets/images/icons/icon-pay-05.png" alt="ICON-PAY">
                </a>
            </div>
        </div>
    </div>
